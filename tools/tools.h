...
# endif
# ifndef __int64
#   if defined(__x86_64__) || defined(__aarch64__) || defined(__powerpc64__) || defined(__loongarch_lp64)
#     define __int64 long
#   else
...
struct target
{
    enum { CPU_i386, CPU_x86_64, CPU_ARM, CPU_ARM64, CPU_ARM64EC, CPU_LOONGARCH64 } cpu;

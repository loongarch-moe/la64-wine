...
static const WORD current_machine = IMAGE_FILE_MACHINE_LOONGARCH64;
#endif
...
{
    return (machine == IMAGE_FILE_MACHINE_AMD64 || machine == IMAGE_FILE_MACHINE_ARM64 || machine == IMAGE_FILE_MACHINE_LOONGARCH64);
}
